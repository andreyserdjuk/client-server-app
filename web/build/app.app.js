...
const ReactDOM = __webpack_require__(/*! react-dom */ 18);
const AjaxTable_1 = __webpack_require__(/*! ./components/AjaxTable */ 27);
let DataAjaxFetcher;
DataAjaxFetcher = (filters, pageSize, currentPage) => {
    ...
    return fetch(`/api/transaction?${query.join('&')}`, { credentials: 'same-origin', mode: 'same-origin' })
        .then((data) => {
        return data.json();
    })
        .then((data) => {
...
ReactDOM.render(React.createElement(AjaxTable_1.AjaxTable, { dataFetcher: DataAjaxFetcher, columns: columns, pageSize: 10 }), document.getElementById("application"));
...
/* 27 */
/*!********************************************!*\
  !*** ./assets/ts/components/AjaxTable.tsx ***!
  \********************************************/
/*! dynamic exports provided */
/*! all exports used */
/***/ (function(module, exports, __webpack_require__) {
...
class AjaxTable extends React.Component {
    ...
    componentDidMount() {
        this.props.dataFetcher({}, this.props.pageSize, 1).then(response => {
    ...
    onFilterChange(e) {
        ...
        const filterValues = Object.assign({}, Object.assign({}, this.state.filterValues, { [targetName]: targetValue }));
    ...
    render() {
        const Row = (props) => {
            ...
            return (React.createElement("tr", null, this.props.columns.map(col => React.createElement("td", { key: col.dataRowKey }, row[col.dataRowKey]))));
        };
        return (React.createElement("div", null,
            React.createElement("table", { className: 'table table-striped table-bordered table-hover' },
                React.createElement("thead", null,
                    React.createElement("tr", null, this.renderFilters())),
                React.createElement("tbody", null, this.state.data.map((rowData) => React.createElement(Row, { key: rowData.transaction_id, data: rowData })))),
            React.createElement("div", null,
                "Total pages: ",
                this.state.totalPages),
            React.createElement("div", { className: "row" },
                React.createElement("div", { className: "col-lg-2 col-sm-3 col-md-3" },
                    React.createElement("div", { className: "input-group" },
                        React.createElement("input", { type: "text", className: "form-control", value: this.state.currentPage, onChange: this.onPageNumChange }),
                        React.createElement("div", { className: "input-group-btn" },
                            React.createElement("button", { type: "button", className: "btn btn-default", onClick: this.prevPage }, "prev"),
                            React.createElement("button", { type: "button", className: "btn btn-default", onClick: this.nextPage }, "next")))))));
    }
    renderFilters() {
        return this.props.columns.map(col => {
            if (col.filterType === 'text') {
                return React.createElement("th", { key: col.dataRowKey },
